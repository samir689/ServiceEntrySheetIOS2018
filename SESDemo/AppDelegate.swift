...
//            self.window!.rootViewController = splitViewController
            ...
            let mainStoryboard : UIStoryboard = UIStoryboard(name: "CustomMain", bundle: nil)
            let initialViewController : UIViewController = mainStoryboard.instantiateViewController(withIdentifier: "MainCustomStoryBoard") as UIViewController
            self.window = UIWindow(frame: UIScreen.main.bounds)
