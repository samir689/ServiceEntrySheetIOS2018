//
// YmSesIosApproveMasterViewController.swift
// SESDemo
//
...
class YmSesIosApproveMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    public var loadEntitiesBlock: ((_ completionHandler: @escaping ([YmSesIosApprove]?, Error?) -> Void) -> Void)?
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! YmSesIosApproveDetailViewController
...
extension YmSesIosApproveMasterViewController: EntitySetUpdaterDelegate {
